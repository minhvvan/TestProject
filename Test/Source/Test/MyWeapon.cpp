...
void AMyWeapon::OnCharacterOverlap(UPrimitiveComponent* OverlppedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
